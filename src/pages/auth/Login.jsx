...
export default function Login() {
  ...
  function entrar(perfil) {
    setLoading(perfil);
    setTimeout(() => {
      navigate(`/login-form?perfil=${perfil}`);
    }, 400);
  }
    ...
    >
      ...
      <div className="flex flex-col items-center gap-6 w-full">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold" style={{ color: "#166534" }}>
            NutriRU
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            Gestão inteligente do Restaurante Universitário
          </p>
        </div>
        ...
        <div className="w-full space-y-3 mt-4">
          ...
          <button
            ...
            style={{
              borderColor:
                loading === "estudante" ? "#166534" : "transparent",
            }}
          >
            <div
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-400">
                Ver cardápio, confirmar presença e avaliar refeições
              </p>
            </div>
            {loading === "estudante" && (
          ...
          <button
            ...
            style={{
              borderColor:
                loading === "gestor" ? "#ea580c" : "transparent",
            }}
          >
            <div
              className="w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0"
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-400">
                Gerenciar cardápios, produção e relatórios
              </p>
            </div>
            {loading === "gestor" && (
